...
<section id="content" class="body">
    <div id="downloadcv">
        ...
        <a href="static/resources/DenisHoctorCV.pdf">
            <img src="/static/images/pdf-icon.gif" alt="PDF Document Icon" title="Download Denis Hoctor's CV in PDF format" />
        </a>
        <a href="static/resources/DenisHoctorCV.doc">
            <img src="/static/images/doc-icon.gif" alt="Word Document Icon" title="Download Denis Hoctor's CV in Word format" />
        </a>
        <a href="static/resources/DenisHoctorCV.html">
            <img src="/static/images/html-icon.gif" alt="HTML Document Icon" title="Download Denis Hoctor's CV in HTML format" />
        </a>            
    </div>
	<h2>DENIS HOCTOR</h2>
    ...
    <h4>May 2004–Apr 2008 Website Designer, Part-time Freelance, Ireland</h4>
    <ul class="list">
    ...
    <h4>Dec 2006–Sept 2007 Ski Instructor, Whistler, Canada &amp; Mt. Hotham, Australia</h4>
    <ul class="list">
    ...
    <h4>Apr 2005–Oct 2005 Executive Officer (IT), Dept. Enterprise, Dublin, Ireland</h4>
    <ul class="list">
	    <li>6 month full time paid position organised through my degree course</li>
    </ul>
    <h3>EDUCATION</h3>
    <h4>Sept 2002–May 2006 Dublin City University, Dublin, Ireland</h4>
    <ul class="list">
    ...
    <h4>Sept 1996–May 2002 Newbridge College, Co. Kildare, Ireland</h4>
    <ul class="list">
	    <li>Graduated with higher level certificates in secondary education</li>
    </ul>
    <h3>INTERESTS &amp; ACTIVITIES</h3>
    <h4>Sept 2002–May 2005	Student Union Class Representative, Dublin, Ireland</h4>
    <ul class="list">
    ...
    <h4>Sept 2003–May 2004 Java Programming Tutor, Dublin, Ireland</h4>
    <ul class="list">
	    <li>Tutored students in the year below</li>
    </ul>
    <h4>Sept 2003–May 2004 Electoral Returning Officer, Dublin, Ireland</h4>
    <ul class="list">
	    <li>Coordinated Student Union elections</li>
	    <li>Organised a team of eight people</li>
    </ul>
    <h4>Sept 2002–May 2003 Student Union Residence Rep., Dublin, Ireland</h4>
    <ul class="list">
	    <li>Liaised with students living on campus and staff running the accommodation to represent the student populous</li>
    </ul>

    <p class="append-top"><span class="title">Sporting:</span> skiing, rugby union (coaching, committee level, playing), rugby league, swimming (competitive), scuba diving</p>
    <p><span class="title">Other Interests:</span> travelling, history, politics, current affairs, building computers</p>

    <h3>References</h3>
    <p>
        <span class="title">Keith Mahon</span> +353 87 674 7705 <a href="mailto:keith@digitalworx.ie">keith@digitalworx.ie</a><br />
        Managing Director, DigitalWorx Ltd., previously IT Manager, MyHome.ie            
    </p>        
    <p>
        <span class="title">Gavin Joyce</span> +353 86 893 5258 <a href="mailto:keith@digitalworx.ie">gavin@myhome.ie</a><br />
        Head of IT Development, MyHome.ie
    </p>
</section>